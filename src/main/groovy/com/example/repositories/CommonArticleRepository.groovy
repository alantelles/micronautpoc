...
@Named("common")
@Singleton
class CommonArticleRepository implements ArticleRepository{
    final EntityManager entityManager;
    final ApplicationConfiguration applicationConfiguration;

    List<String> VALID_PROPERTY_NAMES = ["id", "title", "content"]

    CommonArticleRepository(EntityManager entityManager, ApplicationConfiguration applicationConfiguration) {
